        ...
        <div className='min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 flex items-center justify-center px-2 sm:px-4 pt-24 pb-8'>
            <div className='w-full max-w-md'>
                ...
                <div className='bg-white/90 backdrop-blur-sm shadow-2xl rounded-3xl p-8 border border-gray-100'>
                    <div className='text-3xl font-bold text-gray-800 mb-8 text-center'>Sign Up</div>
                ...
                <div className='mt-6 text-center text-gray-600'>
                    Already a member? <Link className='text-blue-600 hover:text-blue-800 cursor-pointer font-semibold transition-colors duration-200' to={'/login'}>Sign in</Link>
                </div>
            </div>
        </div>
    )
