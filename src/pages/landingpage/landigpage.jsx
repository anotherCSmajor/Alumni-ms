  ...
  return (
    <div className='my-4 py-[50px] md:pl-[120px] px-5 md:flex justify-between'>
        <div className='md:w-[40%]'>
         ...
         <Googlelogincomp/>
            <div className='flex mx-auto mt-[20px] py-2 px-2 bg-white gap-2 rounded-3xl items-center w-[70%] justify-center text-black hover:bg-gray-200 border-2 cursor-pointer'>signin with email</div>
        ...
        <div className='md:w-[50%] h-120 '>
            <img src="/collegefrontpage.jpg" alt="college image" className='w-full h-full '/>
        </div>
